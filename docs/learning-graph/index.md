# Learning Graph for Introduction to American Sign Language
...
- Foundational concepts: 2 entry points
...
- Category organization - foundational elements first, culture & communication last
- Balanced categories (5.0% - 10.0% each)
